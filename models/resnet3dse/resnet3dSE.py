...
class ResnetSE_3DBuilder(object):
    """ResNet3D."""
    ...
    def build_resnet_18(input_shape, num_outputs, reg_factor=1e-4):
        """Build resnet 18."""
        return ResnetSE_3DBuilder.build(input_shape, num_outputs, basic_block,
    ...
    def build_resnet_50(input_shape, num_outputs, reg_factor=1e-4):
        """Build resnet 50."""
        return ResnetSE_3DBuilder.build(input_shape, num_outputs, bottleneck,
                                     [3, 4, 6, 3], reg_factor=reg_factor)
