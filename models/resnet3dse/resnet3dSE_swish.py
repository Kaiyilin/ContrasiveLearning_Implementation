...
def se_block_3D(tensor, ratio):
    ...
    x = Dense(nb_channel // ratio, activation='swish',use_bias=False)(x)
...
def basic_block(filters, strides=(1, 1, 1), kernel_regularizer=l2(1e-4),
    ...
    def f(input):
        ...
        residual_scale = se_block_3D(residual)
        return _shortcut3d(input, residual_scale)
...
def bottleneck(filters, strides=(1, 1, 1), kernel_regularizer=l2(1e-4),
    ...
    def f(input):
        ...
        residual_scale = se_block_3D(residual,16)
        return _shortcut3d(input, residual_scale)
...
class ResnetSEswish_3DBuilder(object):
    """ResNet3D."""
    ...
    def build(input_shape, num_outputs, block_fn, repetitions, reg_factor):
        ...
        pool2 = GlobalAveragePooling3D()(block_output)
        if num_outputs > 1:
    ...
    def build_resnet_18(input_shape, num_outputs, reg_factor=1e-4):
        """Build resnet 18."""
        return ResnetSEswish_3DBuilder.build(input_shape, num_outputs, basic_block,
    ...
    def build_resnet_50(input_shape, num_outputs, reg_factor=1e-4):
        """Build resnet 50."""
        return ResnetSEswish_3DBuilder.build(input_shape, num_outputs, bottleneck,
                                     [3, 4, 6, 3], reg_factor=reg_factor)
